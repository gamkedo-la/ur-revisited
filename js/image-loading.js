...
function loadImages() {
	...
	var imageList = [
		...
		{tileType: TILE_BLANK, theFile: "tile_blank.png"},
		{tileType: TILE_START, theFile: "tile_blank.png"},
		{tileType: TILE_END, theFile: "transparent_block.png"},
		{tileType: TILE_ROSARY, theFile: "tile_rosary.png"},
		{tileType: PLAYER_1_HOME_ROW, theFile: "tile_blank.png"},
		{tileType: PLAYER_2_HOME_ROW, theFile: "tile_blank.png"},

		{tileType: ROLL_BUTTON, theFile: "tile_rosary.png"},
